<x-guest-layout>
   <section class="login-content">
      <div class="row m-0 align-items-center bg-blue vh-100">            
         <div class="col-md-4 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
            <img src="{{asset('images/auth/login.jpg')}}" class="img-fluid gradient-main animated-scaleX" alt="images">
         </div>
         <div class="col-md-8">           
               ...
               <div class="col-md-10">
                  <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                     <div class="card-body">
                        ...
                        <p class="text-center">Créez votre  compte {{env('APP_NAME')}} .</p>
                        ...
                        <form method="POST" action="{{route('register')}}" data-toggle="validator">
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label for="full-name" class="form-label">Prenom</label>
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label for="phone" class="form-label">Numero tel.</label>
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label for="confirm-password" class="form-label">conirmer Mots de passe</label>
                              ...
                              <div class="d-flex justify-content-center">
                                 <div class="form-check mb-3">
                                    <label class="form-check-label" for="customCheck1">Je suis d'accord avec les conditions d'utilisation</label>
                           ...
                           Vous avez déjà un compte  <a href="{{route('auth.signin')}}" class="text-underline">Se connecter</a>
                           </p>
                        </form>
                     </div>
                  </div> 
