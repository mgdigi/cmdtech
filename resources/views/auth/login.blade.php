                     ...
                     <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" data-toggle="validator">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6">
                                 <a href="{{route('auth.recoverpw')}}"  class="float-end">Mots de passe oublié?</a>
                              </div>
                           </div>
                           ...
                           Vous n’avez pas de compte ? <a href="{{route('auth.signup')}}" class="text-underline">Cliquez ici pour vous inscrire.</a>
                           </p>
                        </form>
                     </div>
                  </div>
