              ...
              <div class="card-body p-0">
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3 w-100">
                      <h6 class="mb-0 ">une transaction vient d'etre valide</h6>
                      <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0">Monsieur ndaiye</p>
                        <small class="float-right font-size-12">Tout à l' heure</small>
                      </div>
                    </div>
                  </div>
                </a>
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3 w-100">
                      <h6 class="mb-0 ">Un nouveau client rejoint</h6>
                      <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0">Agent ndiaye</p>
                        <small class="float-right font-size-12">il y a 5 jours</small>
                      </div>
                    </div>
                  </div>
                </a>
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3 w-100">
                      <h6 class="mb-0 ">Il reste la validation de deux clients</h6>
                      <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0">agent mbengue</p>
                        <small class="float-right font-size-12">il y a 2 jours</small>
                      </div>
                    </div>
                  </div>
                </a>
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="w-100 ms-3">
                      <h6 class="mb-0 ">Nouveau courrier </h6>
                      <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0">mbengue</p>
                        <small class="float-right font-size-12">il y a 3 jours</small>
                      </div>
                    </div>
                  </div>
                </a>
        ...
        <li class="nav-item dropdown">
          ...
          <img src="{{asset('images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded">
            <div class="caption ms-3 d-none d-md-block ">
              <h6 class="mb-0 caption-title">{{ auth()->user()->full_name ?? 'nouveau Client'  }}</h6>
              <p class="mb-0 caption-sub-title text-capitalize">{{ str_replace('_',' ',auth()->user()->user_type) ?? 'Client' }}</p>
            </div>
          </a>
