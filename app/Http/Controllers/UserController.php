...
class UserController extends Controller
{
    ...
    public function index(UsersDataTable $dataTable)
    {
        ...
        $assets = ['data-table'];
        $headerAction = '<a href="'.route('users.create').'" class="btn btn-sm btn-primary" role="button">ajouter un utilisateur</a>';
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        if(env('IS_DEMO')) {
            if($role->name === 'comptable'&& $user->user_type === 'comptable') {
